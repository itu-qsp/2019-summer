def count_word_in_text1():
    my_dictionary = {}
    split_text = text.split()
    for element in split_text:
        my_dictionary[element] = 0    
    for element in split_text:
        my_dictionary[element] = my_dictionary[element] + 1
...
def count_word_in_text3():
    my_dictionary = {}
    split_text = text.split()
    for element in split_text:
        my_dictionary[element] = my_dictionary.setdefault(element, 0) + 1
    return my_dictionary
...
print(count_word_in_text1()['woman'])
print(count_word_in_text1())

print(count_word_in_text2()['woman'])
print(count_word_in_text2())

print(count_word_in_text3()['woman'])
print(count_word_in_text3())